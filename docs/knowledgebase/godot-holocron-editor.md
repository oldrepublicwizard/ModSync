...
- **PR:** #111 — Phase 1 archive browser, nested open/save-back, bridge tests (plans `013`–`051`)
...
4. Validation wizard UX lives on [PR #110](https://github.com/th3w1zard1/ModSync/pull/110) — see [gui-validation-surfaces.md](gui-validation-surfaces.md) (synced on this branch in plan `051`).
