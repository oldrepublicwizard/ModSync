# ModSync Client Integration Guide

## Secure Telemetry with HMAC Signing

This guide shows how to integrate HMAC-signed telemetry in ModSync without exposing secrets in your public GitHub repository.
...
```csharp
// File: ModSync/Telemetry/TelemetryAuthenticator.cs

using System;
using System.Security.Cryptography;
using System.Text;

namespace ModSync.Telemetry
{
    /// <summary>
...
```csharp
// File: ModSync/Telemetry/TelemetryService.cs
...
**/telemetry.key
**/EmbeddedSecrets.cs
src/ModSync/Telemetry/EmbeddedSecrets.cs
```

**Create placeholder file (committed to repo):**

```csharp
// File: ModSync/Telemetry/EmbeddedSecrets.cs.example
// 
  ...
  build:
    ...
    steps:
      ...
      - name: Inject Telemetry Secret (Official Builds Only)
        ...
        shell: pwsh
        run: |
          $secretFile = "src/ModSync/Telemetry/EmbeddedSecrets.cs"
          $content = @"
