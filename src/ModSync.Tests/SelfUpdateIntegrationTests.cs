...
namespace ModSync.Tests
{
    ...
    public sealed class SelfUpdateIntegrationTests
    {
        ...
        public void SetUp()
        {
            _tempRoot = Path.Combine(Path.GetTempPath(), "ModSync_SelfUpdateTests", Guid.NewGuid().ToString("N"));
        ...
        public async Task ApplyUpdateAsync_ZipArchive_GeneratesReplacementScriptAndLaunchInfo()
        {
            ...
            string currentProcessPath = Path.Combine(_tempRoot, "current", "ModSync.dll");
            ...
            {
                ZipArchiveEntry entry = archive.CreateEntry("payload/ModSync.dll");
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(File.Exists(Path.Combine(result.PayloadRoot, "ModSync.dll")), Is.True, "Extracted payload should contain application binary");
        ...
        public void BuildWindowsScript_ContainsCopyAndRestartSteps()
        {
            string script = AutoUpdateCoordinator.BuildWindowsScript(
                ...
                targetDir: @"C:\app",
                executablePath: @"C:\app\ModSync.exe",
        ...
        public void BuildUnixScript_ContainsCopyAndRestartSteps()
        {
            string script = AutoUpdateCoordinator.BuildUnixScript(
                ...
                targetDir: "/opt/app",
                executablePath: "/opt/app/ModSync",
