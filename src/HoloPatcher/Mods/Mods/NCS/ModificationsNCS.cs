...
namespace HoloPatcher.Mods.NCS
{
    ...
    {
        public List<ModifyNCS> Modifiers { get; set; } = new List<ModifyNCS>();

        public ModificationsNCS(string filename, bool? replace = null, [CanBeNull] List<ModifyNCS> modifiers = null)
