...
{
    public class ModuloAssignmentExpression : Expression
    {
        public FieldAccess FieldAccess { get; set; }
        public Expression Value { get; set; }

        public ModuloAssignmentExpression(FieldAccess fieldAccess, Expression value)
        {
        ...
        public override DynamicDataType Compile(NCS ncs, CodeRoot root, CodeBlock block)
        {
            ...
            ncs.Add(NCSInstructionType.MODII, new List<object>());
