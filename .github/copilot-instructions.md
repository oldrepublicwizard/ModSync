...
- **Open PR tracks:** validation wizard work is [#110](https://github.com/th3w1zard1/ModSync/pull/110); Godot Holocron is [#111](https://github.com/th3w1zard1/ModSync/pull/111) — see `AGENTS.md` § Parallel open PRs and [doc-hierarchy.md](../docs/knowledgebase/doc-hierarchy.md#active-open-prs-2026-06-03).
